-- Previous migrations (from add-social-features.sql)
...
BEGIN
    IF EXISTS (
        ...
        WHERE table_name='video_calls' AND column_name='host_id'
    ) THEN
...
-- NEW: Create message_reactions table
...
-- NEW: Create group_members table
...
-- NEW: Create group_messages table
